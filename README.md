...
Earlier on the term "programming as non-linear storytelling" was introduced. I have to admit that I just made that up when trying to find a way to explain how working code often comes into being in a very non-linear way. This also means that it should also be read - or better explored - in a non-linear way. 
