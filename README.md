...
This description of the rules and the gameplay can double already as a high level description of the implementation of the game. It can also be read as an abstract story about a game, where the concrete story would be the descriptions of an actual game. The program code can be viewed as an abstract story, with different executions of it as concrete expressions. If you have no idea what I mean just watch [this](https://www.youtube.com/watch?v=oP3c1h8v2ZQ) and transfer your insights into thinking about programs :)
