...
Switching into egghead mode, you could say that a game of Mau Mau can be modelled as a series of interactions between clearly defined entities with state preserving attributes and behaviours modifying their own state and those of other entities. If you call the entities objects and the behaviour methods you have a basic description of object oriented programming.
