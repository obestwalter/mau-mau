...
# -*- coding: utf-8 -*-
#
# Mau Mau documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../../mau_mau'))
...
latex_documents = [
    (master_doc, 'MauMau.tex', 'Mau Mau Documentation',
     'Oliver Bestwalter', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'MauMau', 'Mau Mau Documentation',
     author, 'MauMau', 'One line description of project.',
     'Miscellaneous'),
]
